...
public class PiramideInvertida{
    ...
    public static void main(String[] args){
        ...
        System.out.println("\n");
        /*Se instancia el método "PiramideInvertida" y se genera el método "dibujarPiramideInvertida"*/
        PiramideInvertida dibujo = new PiramideInvertida(numero);
        dibujo.dibujarPiramideInvertida();
        /*Se cierra el escáner*/
        usuario.close();
    }
    /*Se crea un método privado con un atributo de variable numérica almacenable*/
    private int numero;
    /*Se crea el método "PiramideInvertida" y el constructor para la variable de dicho método*/
    public PiramideInvertida(int numero){
        this.numero = numero;
    }
    /*Se crea el método "dibujarPiramideInvertida" donde se encontrará el código funcional del programa*/
    public void dibujarPiramideInvertida(){
        /*Se crea la ventana/mensaje emergente para interactuar con el usuario*/
        ...
        for (int altura = numero; altura >= 1; altura--){
